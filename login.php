...
<head>
    ...
    <style>
        body {
            background-image: url('cakeb-bg2.jpg');
...
<body>
     ...
     <div class="container d-flex justify-content-center align-items-center min-vh-100">
       ...
       <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #ffbd59;">
           <div class="featured-image mb-3">
            <img src="2.png" class="img-fluid " style="width: 300px;">
           </div>
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-3">
                    <button class="btn btn-lg  w-100 fs-6 text-light" id="btn">Login</button>
                </div>
                <div class="input-group mb-3">
                ...
                <div class="row">
                    <small>Don't have account? <a class="link" href="reg.php">Sign Up</a></small>
                </div>
          </div>
       </div> 
